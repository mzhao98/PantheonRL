...
from influence_envs.collaborative_rps import collaborative_rps_env
...
def generate_env():
    env = collaborative_rps_env(num_actions=3, max_cycles=15)
...
def test_trained_partner_model(game_name, num_episodes=10):
    ...
    partner_action_distribution = {0: [], 1:[], 2:[], 3:[]}
    ego_action_distribution = {0: [], 1: [], 2: [], 3:[]}
...
if __name__ == '__main__':
    game = 'collab-rps_(full_rew)_influence_exp1_(2_tan)_lstm'
