...
def generate_env():
    env = joint_particle_env(num_actions=4, max_cycles=15)
...
class EgoRPSAgent():
    ...
    def construct_dataset(self):
        ...
        for i in range(1, len(game_data)-1):
            add_x = []
            if 4 in game_data[i] or 4 in game_data[i+1] or 4 in game_data[i-1]:
                continue
...
def run_test(ego, env, num_episodes, render=False):
    number_to_action = {0: 'N', 1: 'S', 2: 'E', 3:'W', 4:'None'}


    rewards = []
    game_results = {}

    action_distribution_ego = {0:0, 1:0, 2:0, 3:0, 4:0}
    action_distribution_partner = {0: 0, 1: 0, 2: 0, 3:0, 4:0}
    ...
    normalized_action_distribution_ego = {0:action_distribution_ego[0]/ego_action_sum,
                                          ...
                                          3:action_distribution_ego[3]/ego_action_sum}
    ...
    normalized_partner_distribution_ego = {0: action_distribution_partner[0] / partner_action_sum,
                                          1: action_distribution_partner[1] / partner_action_sum,
                                           ...
                                           3: action_distribution_partner[3] / partner_action_sum}
...
def train(game_name):
    ...
    for ep in range(num_prediction_epochs):
        ...
        print(f'episode {ep}: partner_action_distribution = {partner_action_distribution}')
        print(f'episode {ep}: ego_action_distribution = {ego_action_distribution}')
...
def test_trained_partner_model(game_name, num_episodes=10):
    ...
    partner_action_distribution = {0: [], 1:[], 2:[], 3:[], 4:[]}
    ego_action_distribution = {0: [], 1: [], 2: [], 3:[], 4:[]}
...
if __name__ == '__main__':
    game = 'collab-particle_(full_rew)_influence_exp0_lstm'
