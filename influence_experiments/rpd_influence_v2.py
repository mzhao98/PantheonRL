...
from influence_experiments.influence_envs import rpd_v2
...
def generate_env(max_cycles):
    env = rpd_v2.env(max_cycles=max_cycles)
...
if __name__ == '__main__':
    game = 'fullcoop-rpd-v2_env-rew_influence_exp2_repeat_lstm'
    game ='rpd_dummy'
    ...
    game_params = {
        ...
        'default_marginal_probability': [0, 0],
        'number_to_action': {0: 'Cooperate', 1: 'Defect'},
        'number_to_color': {0: 'g', 1: 'r'},
        'partner_params':  {
                'learning_rate': 0.01,
                'input_size': 1,
                'hidden_size': 20,
