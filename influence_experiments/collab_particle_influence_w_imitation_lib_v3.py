...
def plot_over_time_distribution(game, desired_strategy, over_time_distribution, savename=''):
    ...
    for observation in observation_list:
        ...
        plt.savefig(f'{game}/images/observation_{observation}_'+savename+'.png')
        plt.close()



if __name__ == '__main__':
    game = 'collab-particle-v3_full-rew_influence_exp0_lstm'
    ...
    desired_strategy = {(5,0): [0.97, 0.01, 0.01, 0.01],
                    (4,0): [0.49, 0.01, 0.01, 0.49],
                    (3,0): [0.49, 0.01, 0.01, 0.49],
                    (2,0): [0.49, 0.01, 0.01, 0.49],
