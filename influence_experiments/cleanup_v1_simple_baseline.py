...
def train(game_params):
    ...
    ego_ppo = generate_ego(env, action_to_one_hot, default_marginal_probability, desired_strategy, partner_params)
...
if __name__ == '__main__':
    ...
    game = 'simple_cleanup_v0_exp5_baseline-2onpolicy_5iters_rew-env'
